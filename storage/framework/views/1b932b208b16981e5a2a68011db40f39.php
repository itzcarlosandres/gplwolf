<form action="<?php echo e(route('admin.settings.payments.update')); ?>" method="POST">
    <?php echo csrf_field(); ?>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="manual_payment_bank" rows="4"
                            class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/10 transition-all font-bold placeholder-gray-700 resize-none"><?php echo e($settings['manual_payment_bank'] ?? ''); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="manual_payment_binance" rows="4"
                            class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/10 transition-all font-bold placeholder-gray-700 resize-none"><?php echo e($settings['manual_payment_binance'] ?? ''); ?></textarea>
                    </div>

                    <!-- PayPal Manual -->
                    <div>
                        <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.15em] mb-2">PayPal (Correo Manual)</label>
                        <input type="text" name="manual_payment_paypal" value="<?php echo e($settings['manual_payment_paypal'] ?? ''); ?>" placeholder="pago@ejemplo.com"
                    ...
                    <div>
                        ...
                        <textarea name="manual_payment_instructions" rows="3"
                            class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-emerald-500/50 focus:ring-2 focus:ring-emerald-500/10 transition-all font-bold placeholder-gray-700 resize-none"><?php echo e($settings['manual_payment_instructions'] ?? ''); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-[#0a0a0a] border border-white/[0.06] rounded-2xl overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="text" name="paypal_client_id" value="<?php echo e($settings['paypal_client_id'] ?? ''); ?>"
                        ...
                        <div>
                            ...
                            <input type="password" name="paypal_secret" value="<?php echo e($settings['paypal_secret'] ?? ''); ?>"
                                class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#FF2121]/50 focus:ring-2 focus:ring-[#FF2121]/10 transition-all font-bold placeholder-gray-700">
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                <select name="paypal_mode" class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#FF2121]/50 focus:ring-2 focus:ring-[#FF2121]/10 transition-all font-bold appearance-none">
                                    <option value="sandbox" <?php echo e(($settings['paypal_mode'] ?? '') == 'sandbox' ? 'selected' : ''); ?>>Sandbox</option>
                                    <option value="live" <?php echo e(($settings['paypal_mode'] ?? '') == 'live' ? 'selected' : ''); ?>>Live</option>
                                </select>
                ...
                <div class="bg-[#0a0a0a] border border-white/[0.06] rounded-2xl overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="text" name="coinpal_merchant_no" value="<?php echo e($settings['coinpal_merchant_no'] ?? ''); ?>"
                                class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#FF2121]/50 focus:ring-2 focus:ring-[#FF2121]/10 transition-all font-bold placeholder-gray-700">
                        </div>
                        <div>
                            <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.15em] mb-2">API Key</label>
                            <input type="password" name="coinpal_api_key" value="<?php echo e($settings['coinpal_api_key'] ?? ''); ?>"
                                class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#FF2121]/50 focus:ring-2 focus:ring-[#FF2121]/10 transition-all font-bold placeholder-gray-700">
                        </div>
                        <div>
                            <label class="block text-[11px] font-black text-gray-400 uppercase tracking-[0.15em] mb-2">Mode</label>
                            <div class="relative">
                                <select name="coinpal_mode" class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#FF2121]/50 focus:ring-2 focus:ring-[#FF2121]/10 transition-all font-bold appearance-none">
                                    <option value="sandbox" <?php echo e(($settings['coinpal_mode'] ?? '') == 'sandbox' ? 'selected' : ''); ?>>Sandbox</option>
                                    <option value="live" <?php echo e(($settings['coinpal_mode'] ?? '') == 'live' ? 'selected' : ''); ?>>Live</option>
                                </select>
                                <div class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none">
                                    <i class="fas fa-chevron-down text-xs"></i>
                                </div>
...
</form><?php /**PATH C:\MAMP\htdocs\gplwolf\resources\views/admin/settings/tabs/payments.blade.php ENDPATH**/ ?>