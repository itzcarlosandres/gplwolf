<form action="<?php echo e(route('admin.settings.gamification.update')); ?>" method="POST">
    <?php echo csrf_field(); ?>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="bg-[#080808] rounded-xl border border-white/[0.08] p-4 flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="active" class="sr-only peer" <?php echo e(($rewards['active'] ?? true) ? 'checked' : ''); ?>>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                        ...
                        <div class="bg-[#080808] p-4 rounded-xl border border-white/[0.08] text-center relative group hover:border-white/20 transition-all hover:-translate-y-1">
                            <span class="text-[10px] font-black text-gray-500 uppercase block mb-3 tracking-wider">Día <?php echo e($i); ?></span>
                            <div class="relative">
                                <input type="number" name="rewards[<?php echo e($i); ?>]" value="<?php echo e($rewards['rewards'][$i] ?? ($i * 10)); ?>"
                        ...
                        <div class="bg-gradient-to-br from-red-900/40 to-[#F51B1B]/40 p-4 rounded-xl border border-red-500/30 text-center relative group hover:-translate-y-1 transition-transform">
                            ...
                            <div class="relative">
                                <input type="number" name="rewards[7]" value="<?php echo e($rewards['rewards'][7] ?? 150); ?>"
...
<!-- Ranks Configuration -->
<form action="<?php echo e(route('admin.settings.ranks.update')); ?>" method="POST" class="mt-6">
    <?php echo csrf_field(); ?>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-12 gap-4 items-center bg-[#080808] hover:bg-white/[0.02] p-4 rounded-xl border border-white/[0.08] transition-colors group">
                    <input type="hidden" name="ranks[<?php echo e($index); ?>][id]" value="<?php echo e($rank->id); ?>">

                    <!-- Name -->
                    <div class="col-span-3">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-lg flex items-center justify-center shadow-lg" style="background-color: <?php echo e($rank->color); ?>20; color: <?php echo e($rank->color); ?>">
                                <i class="<?php echo e($rank->icon ?? 'fas fa-shield-alt'); ?>"></i>
                            </div>
                            <input type="text" name="ranks[<?php echo e($index); ?>][name]" value="<?php echo e($rank->name); ?>"
                    ...
                    <div class="col-span-3 relative">
                        <input type="number" name="ranks[<?php echo e($index); ?>][min_points]" value="<?php echo e($rank->min_points); ?>"
                    ...
                    <!-- Discount -->
                    <div class="col-span-3 relative">
                        <input type="number" step="0.01" name="ranks[<?php echo e($index); ?>][discount_percentage]" value="<?php echo e($rank->discount_percentage); ?>"
                    ...
                    <div class="col-span-3 flex items-center gap-2">
                        <input type="color" name="ranks[<?php echo e($index); ?>][color]" value="<?php echo e($rank->color); ?>"
...
</form><?php /**PATH C:\MAMP\htdocs\gplwolf\resources\views/admin/settings/tabs/gamification.blade.php ENDPATH**/ ?>