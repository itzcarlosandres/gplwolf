<form action="<?php echo e(route('admin.settings.topbar.update')); ?>" method="POST">
    <?php echo csrf_field(); ?>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="bg-[#080808] rounded-xl border border-white/[0.08] p-4 flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="topbar_enabled" class="sr-only peer" <?php echo e(($settings['topbar_enabled'] ?? 1) ? 'checked' : ''); ?>>
                ...
                <div>
                    ...
                    <input type="text" name="topbar_text" value="<?php echo e(old('topbar_text', $settings['topbar_text'] ?? '🎉 Oferta especial: 50% de descuento en todos los planes anuales')); ?>" required
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="topbar_link" value="<?php echo e(old('topbar_link', $settings['topbar_link'] ?? '')); ?>" placeholder="https://ejemplo.com/promo"
            ...
            <div class="p-8 flex-1 relative overflow-hidden flex flex-col items-center justify-center">
                ...
                <div class="w-full max-w-sm bg-[#080808] rounded-xl border border-white/[0.06] overflow-hidden shadow-2xl relative z-10">
                    ...
                    <div class="bg-gradient-to-r from-pink-600 to-[#F51B1B] px-4 py-2 flex items-center justify-center text-[10px] font-black text-white text-center leading-tight">
                        <?php echo e($settings['topbar_text'] ?? '🎉 Oferta especial: 50% de descuento.'); ?>
...
</form><?php /**PATH C:\MAMP\htdocs\gplwolf\resources\views/admin/settings/tabs/topbar.blade.php ENDPATH**/ ?>