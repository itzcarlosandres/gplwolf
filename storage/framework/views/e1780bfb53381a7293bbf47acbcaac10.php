<form action="<?php echo e(route('admin.settings.storage.update')); ?>" method="POST">
    <?php echo csrf_field(); ?>
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="storage_driver" value="public" class="peer sr-only" <?php echo e(($settings['storage_driver'] ?? 'public') == 'public' ? 'checked' : ''); ?>>
                        ...
                        <!-- BunnyCDN -->
                        <label class="cursor-pointer">
                            <input type="radio" name="storage_driver" value="bunnycdn" class="peer sr-only" <?php echo e(($settings['storage_driver'] ?? '') == 'bunnycdn' ? 'checked' : ''); ?>>
                        ...
                        <!-- R2 -->
                        <label class="cursor-pointer">
                            <input type="radio" name="storage_driver" value="r2" class="peer sr-only" <?php echo e(($settings['storage_driver'] ?? '') == 'r2' ? 'checked' : ''); ?>>
            ...
            <div class="bg-[#0a0a0a] border border-white/[0.06] rounded-2xl overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="<?php echo e(env('BUNNYCDN_API_KEY') ? 'text-emerald-400' : 'text-rose-400'); ?> font-bold">
                            <?php echo e(env('BUNNYCDN_API_KEY') ? 'Configurado' : 'Faltante'); ?>

                        </span>
                    </div>
                    <div class="flex justify-between text-xs">
                        <span class="text-gray-400 font-bold uppercase tracking-wider">Zone Name</span>
                        <span class="<?php echo e(env('BUNNYCDN_STORAGE_ZONE') ? 'text-emerald-400' : 'text-rose-400'); ?> font-bold">
                            <?php echo e(env('BUNNYCDN_STORAGE_ZONE') ?: 'Faltante'); ?>
            ...
            <div class="bg-[#0a0a0a] border border-white/[0.06] rounded-2xl overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="<?php echo e(env('CLOUDFLARE_R2_ACCESS_KEY_ID') ? 'text-emerald-400' : 'text-rose-400'); ?> font-bold">
                            <?php echo e(env('CLOUDFLARE_R2_ACCESS_KEY_ID') ? 'Configurado' : 'Faltante'); ?>

                        </span>
                    </div>
                    <div class="flex justify-between text-xs">
                        <span class="text-gray-400 font-bold uppercase tracking-wider">Bucket</span>
                        <span class="<?php echo e(env('CLOUDFLARE_R2_BUCKET') ? 'text-emerald-400' : 'text-rose-400'); ?> font-bold">
                            <?php echo e(env('CLOUDFLARE_R2_BUCKET') ?: 'Faltante'); ?>
...
</form><?php /**PATH C:\MAMP\htdocs\gplwolf\resources\views/admin/settings/tabs/storage.blade.php ENDPATH**/ ?>