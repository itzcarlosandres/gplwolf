        ...
        <div class="bg-gray-800/40 backdrop-blur-xl p-8 rounded-3xl border border-white/5 shadow-2xl">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center p-4 bg-amber-500/10 rounded-2xl border border-amber-500/20 group cursor-pointer hover:bg-amber-500/15 transition-all">
                    ...
                    <input type="checkbox" name="is_best_seller" value="1" id="is_best_seller" class="w-6 h-6 text-amber-500 bg-gray-900 border-white/10 rounded-lg focus:ring-amber-500 focus:ring-offset-gray-900 transition-all cursor-pointer">
                ...
                <div class="flex items-center p-4 bg-sky-500/10 rounded-2xl border border-sky-500/20 group cursor-pointer hover:bg-sky-500/15 transition-all">
                    ...
                    <input type="checkbox" name="is_popular" value="1" id="is_popular" class="w-6 h-6 text-sky-500 bg-gray-900 border-white/10 rounded-lg focus:ring-sky-500 focus:ring-offset-gray-900 transition-all cursor-pointer">
