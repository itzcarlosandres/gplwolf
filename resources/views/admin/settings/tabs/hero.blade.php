            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="hero_style" value="{{ $key }}" class="peer sr-only" {{ ($settings['hero_style'] ?? '') == $key ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <textarea name="hero_title" rows="3" required
                        class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#FF2121]/50 focus:ring-2 focus:ring-[#FF2121]/10 transition-all font-bold leading-tight placeholder-gray-700">{{ $settings['hero_title'] ?? "Themes & Plugins\n[G]Premium WP[/G]" }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="hero_description" rows="3" required
                        class="w-full bg-[#080808] border border-white/[0.08] rounded-xl px-4 py-3 text-white text-sm focus:outline-none focus:border-[#FF2121]/50 focus:ring-2 focus:ring-[#FF2121]/10 transition-all font-bold leading-relaxed placeholder-gray-700">{{ $settings['hero_description'] ?? 'Impulsa tus proyectos con los mejores recursos digitales.' }}</textarea>
                </div>
